package com.w4ma.soft.tamenly.CategoryActivities.Models.BooksModel;
...
public class BookList extends RealmObject {
    ...
    public BookList( int realmID,String post_id, String post_title, String post_real_price, String currency, String post_description, String post_image, String post_datetime, String category, String user_name, String user_pp, String user_ID) {
        this.realmID = realmID;
        this.post_id = post_id;
        this.post_title = post_title;
        this.post_real_price = post_real_price;
