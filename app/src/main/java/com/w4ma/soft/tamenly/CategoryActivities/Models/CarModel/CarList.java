...
public class CarList extends RealmObject {
    public CarList() {
    }

    public CarList(int realmID, String post_id, String post_title, String post_real_price, String currency, String post_description, String post_image, String post_datetime, String category, String user_name, String user_pp, String user_ID) {
